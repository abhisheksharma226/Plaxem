        ...
        >
          <g clipPath="url(#clip0_login)">
            <mask
              ...
              height="812"
            >
              <rect x="10" y="-0.84668" width="1200" height="811.693" fill="url(#paint0_linear_login)" />
            </mask>
          ...
          <defs>
            ...
            >
              ...
              <feGaussianBlur stdDeviation="159.394" result="effect1_foregroundBlur_login" />
            </filter>
            <filter
              id="filter1_login"
              x="-554.207"
            ...
            >
              <feFlood floodOpacity="0" result="BackgroundImageFix" />
              <feBlend mode="normal" in="SourceGraphic" in2="BackgroundImageFix" result="shape" />
              <feGaussianBlur stdDeviation="478.182" result="effect1_foregroundBlur_login" />
            </filter>
            <linearGradient
        ...
        <div className="w-full max-w-[400px]">
          <div className="space-y-8">
            ...
            <div className="space-y-3 text-center">
              <h1 className="text-foreground text-3xl md:text-4xl font-semibold leading-tight">Welcome back</h1>
              <p className="text-muted-foreground text-base font-medium">Sign in to your account to continue</p>
            </div>
